...
<head>
  ...
  <title>Sahnoun - Mot de passe oublié</title>
...
<body class="flex flex-col md:flex-row min-h-screen w-full">
  <div class="hidden md:flex animated-bg text-white p-8 flex-col items-center justify-center">
    ...
    <div class="text-center mb-16">
      <h1 class="text-4xl font-bold mb-2">Mot de passe oublié ?</h1>
      <p class="text-lg text-indigo-100 mt-4">Pas de souci, nous allons vous aider à le réinitialiser.</p>
    </div>
  </div>

  <div class="right-side bg-white p-8 flex flex-col justify-center">
    <div class="max-w-lg mx-auto w-full">
      <h2 class="text-3xl font-bold text-gray-800 mb-6">Réinitialiser le mot de passe</h2>
