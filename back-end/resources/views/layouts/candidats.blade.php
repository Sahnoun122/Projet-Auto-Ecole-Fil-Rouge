    ...
    <div class="flex h-screen">
        ...
        >
            ...
            <nav class="flex-1 py-4 overflow-hidden hover:overflow-y-auto">
                ...
                <a href="{{ route('logout') }}"
                   onclick="event.preventDefault(); document.getElementById('logout-form-candidat').submit();"
                   class="sidebar-item flex items-center px-4 py-3 text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <form id="logout-form-candidat" action="{{ route('logout') }}" method="POST" style="display: none;">
                    @csrf
                </form>
            </nav>
        </div>
