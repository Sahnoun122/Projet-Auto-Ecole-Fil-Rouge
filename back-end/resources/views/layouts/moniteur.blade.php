...
<head>
    ...
    <title>Auto-école Sahnoun - Moniteur</title>
    ...
    <div class="flex h-screen">
        ...
        >
            ...
            <nav class="flex-1 py-4 overflow-hidden hover:overflow-y-auto">
                ...
                <a href=""
                   class="sidebar-item flex items-center px-4 py-3 text-gray-600 {{ request()->routeIs('') ? 'active-sidebar-item' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href=""
                   class="sidebar-item flex items-center px-4 py-3 text-gray-600 {{ request()->routeIs('') ? 'active-sidebar-item' : '' }}">
                    ...
                    <span :class="sidebarOpen ? 'block ml-3' : 'hidden'">Cours</span>
                </a>
                ...
                <a href=""
                   class="sidebar-item flex items-center px-4 py-3 text-gray-600 {{ request()->routeIs('') ? 'active-sidebar-item' : '' }}">
                    ...
                    <span :class="sidebarOpen ? 'block ml-3' : 'hidden'">Planning</span>
                </a>
                        ...
                        <div x-show="notificationsOpen" 
                            ...
                            <div class="max-h-64 overflow-y-auto">
                                <a href="#" class="block px-4 py-3 hover:bg-gray-50">
                                    <p class="text-sm text-gray-900">Nouvelle séance de conduite planifiée</p>
                                    <p class="text-xs text-gray-500">Il y a 5 minutes</p>
                                </a>
                                <a href="#" class="block px-4 py-3 hover:bg-gray-50">
                                    <p class="text-sm text-gray-900">Examen à superviser demain</p>
                                    <p class="text-xs text-gray-500">Il y a 1 heure</p>
                                </a>
                                <a href="#" class="block px-4 py-3 hover:bg-gray-50">
                                    <p class="text-sm text-gray-900">Nouveau candidat assigné</p>
