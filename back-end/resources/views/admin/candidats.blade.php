            ...
            <form id="candidatForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="file" id="candidatPhotoIdentite" name="photo_identite" accept="application/pdf" class="w-full">
                        ...
                        <div id="currentPhotoIdentite" class="mt-2 hidden">
                            ...
                            <a id="photoIdentiteLink" href="#" target="_blank" class="text-blue-500 text-sm block mt-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <a id="detailPhotoIdentiteLink" href="#" target="_blank" class="text-blue-500 text-sm block mt-2">
                            <i class="fas fa-file-pdf mr-1"></i> Voir le document
                        </a>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.photo_identite) {
                    $('#detailPhotoIdentiteLink').attr('href', "{{ asset('storage') }}/" + data.photo_identite);
                }
