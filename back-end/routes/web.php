...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('titles/{title}/progress', [TitleController::class, 'progress'])->name('admin.progress');
    Route::get('titles/{title}/candidate/{candidate}/progress', [TitleController::class, 'candidateProgress'])->name('admin.candidate-progress');
    ...
    Route::get('/vehicles/maintenance-alerts', [VehicleController::class, 'maintenanceAlerts'])->name('admin.vehicles.maintenance-alerts');
    ...
    Route::get('/conduite/{id}/presences', [CoursConduiteController::class, 'getPresences'])->name('admin.conduite.presences');
    ...
    Route::post('/questions/{question}/image', [QuestionController::class, 'updateImage'])->name('admin.questions.updateImage');
});

Route::get('/email/unsubscribe/{user}/{token}', [NotificationController::class, 'unsubscribe'])->name('email.unsubscribe');
...
Route::prefix('candidats')->middleware(['auth', 'role:candidat'])->group(function () {
    ...
    Route::get('/{quiz}/prepare', [QuizController::class, 'prepareQuiz'])->name('candidats.prepare');
    Route::get('/{quiz}/start', [QuizController::class, 'startQuiz'])->name('candidats.start');
    Route::get('/{quiz}/questions/{question}', [QuizController::class, 'showQuestion'])->name('candidats.questions');
    Route::post('/{quiz}/questions/{question}', [QuizController::class, 'submitAnswer'])->name('candidats.questions');
...
Route::prefix('moniteur')->middleware(['auth', 'role:moniteur'])->name('moniteur.')->group(function() {
    ...
    Route::get('/candidats', [MoniteurController::class, 'candidats'])->name('candidats');
